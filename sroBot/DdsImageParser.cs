...
namespace sroBot
{
    #region DdsImageParser Class
    public class DdsImageParser : IDisposable
    {
        #region Variables
        ...
        public DdsImageParser(byte[] ddsImage)
        {
        ...
        public DdsImageParser(Stream ddsImage)
        {
            if (ddsImage == null) return;
        ...
        private DdsImageParser(System.Drawing.Bitmap bitmap)
        {
        ...
        #region Operators
        public static implicit operator DdsImageParser(System.Drawing.Bitmap value)
        {
            return new DdsImageParser(value);
        }

        public static explicit operator System.Drawing.Bitmap(DdsImageParser value)
        {
